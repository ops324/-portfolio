...
| 説明文 | Noto Sans JP、0.88rem、`var(--muted)` |
...
| 本文1 | 「気になったことはすぐ試す。そのくり返しからプロダクトが生まれると思っています。使いやすさと美しさにはこだわります。」 |
| 本文2 | 「趣味は探索・エンタメ鑑賞・新技術のキャッチアップ。」 |
...
|---|---|
| レイアウト | 2カラムグリッド（左: ラベル 180px 固定 / 右: コンテンツ） |
| リードテキスト | 「お仕事のご依頼・ご質問はお気軽にどうぞ。」 |
| リンク | メールアドレス・GitHub・X (Twitter) を縦並び |
