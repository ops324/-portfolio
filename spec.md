...
| 2.1.1 | 2026-03-08 | noteセクションに @tech_news_（TECH NEWS）アカウントを追加。計3アカウント掲載 |
...
| 左側 | アイコン（`サイトアイコン.png` 20px・opacity 0.75）＋ロゴ（名前：`滝本 哲也`） |
...
| 3 | @tech_news_ | 世界で動いているTECH NEWSを発信。 | https://note.com/tech_news_ |
